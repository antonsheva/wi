...
var dbM = require('../models');
var TokenModel = dbM.token;
var TokenService = /** @class */ (function () {
    function TokenService() {
    }
    TokenService.prototype.generateTokens = function (payload) {
        var accessToken = jwt.sign(payload, process.env.JWT_ACCESS_SECRET, { expiresIn: '30m' });
        var refreshToken = jwt.sign(payload, process.env.JWT_REFRESH_SECRET, { expiresIn: '30d' });
        return {
    ...
    TokenService.prototype.saveToken = function (userId, refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokenModel = TokenModel.findOne({ where: { user_id: userId } });
                        if (tokenModel) {
                            TokenModel.update({ refresh_token: refreshToken }, { where: { user_id: userId } });
                        }
                        return [4 /*yield*/, TokenModel.create({ refresh_token: refreshToken, user_id: userId })];
    ...
    TokenService.prototype.removeToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TokenModel.destroy({ where: { refresh_token: refreshToken } })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    TokenService.prototype.findToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TokenModel.findOne({ where: { refresh_token: refreshToken } })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
